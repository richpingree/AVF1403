...
// in simulator we redefine to format for Geocoder Developer console
...
{\
	NSString * exceptionName = [@"org.geocoder." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.geocoder";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGeocoderNativeItemNone = -1, 
	UIGeocoderNativeItemSpinner = -2,
	UIGeocoderNativeItemProgressBar = -3,
	
	UIGeocoderNativeItemSlider = -4,
	UIGeocoderNativeItemSwitch = -5,
	UIGeocoderNativeItemMultiButton = -6,
	UIGeocoderNativeItemSegmented = -7,
	
	UIGeocoderNativeItemTextView = -8,
	UIGeocoderNativeItemTextField = -9,
	UIGeocoderNativeItemSearchBar = -10,
	
	UIGeocoderNativeItemPicker = -11,
	UIGeocoderNativeItemDatePicker = -12,
	
	UIGeocoderNativeItemInfoLight = -13,
	UIGeocoderNativeItemInfoDark = -14,
	
	UIGeocoderNativeItemDisclosure = -15,
	
	UIGeocoderNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Geocoder instances of

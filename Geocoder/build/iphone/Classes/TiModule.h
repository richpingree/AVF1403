...
/**
 The base class for all Geocoder modules
 */
...
/**
 Geocoder Platform calls this method on startup.
 */
-(void)startup;

/**
 Geocoder Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Geocoder Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Geocoder Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Geocoder Platform calls this method on resume.
 @param sender The sender of the event.
 */
